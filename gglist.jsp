...
<!--<form id="memberForm">-->
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> Announcement list</strong> </div><!-- 公告列表 -->
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<%=path %>/ggadd.jsp">Add</a> </li>
        <li>Search：</li>
        <li>
        <form id="memberForm">
      ...
      <tr>
       ...
       <%
         ...
         <tr>
          ...
          <a class="button border-main" href="<%=path %>/ggmodifybefore.action?id=<%=bean.getId()%>"><span class="icon-edit"></span> Modify</a>
